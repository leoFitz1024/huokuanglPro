 ...
 */
@ExcelTarget("returnExcelEntity")
public class ReturnExcelEntity {
    ...
    public ReturnExcelEntity(int id, String code, String rangesize, String color, Float price, int number, Float allprice) {
        this.id = id;
        this.code = code;
        this.rangesize = rangesize;
        this.color = color;
